...
class Notice extends CI_Controller {
    ...
    /*        $isValidNotice = TRUE;
            ...
            if (strLen($notice['albumName'])< 3)
            {
            $isValidNotice = FALSE;
           $invalidMessageNotice = "Album Name CANNOT be blank or less than 3 characters. Please re-enter details ... <br>";
                
            }
            
                   if (strLen($notice['artistName'])< 3)
            {
            $isValidNotice = FALSE;
           $invalidMessageNotice = "Artist Name CANNOT be blank or less than 3 characters. Please re-enter details ... <br>";
                
            }
            
            
        if($isValidNotice == FALSE)
        { $isValidNotice = TRUE;
     ...
     echo"<p> ============= </p>" ;
         ...
         echo"<p> ===========</p>";
    echo "<p>" .$invalidMessageNotice. "</p>";
        echo"<p> ============= </p>" ;
         echo"<p> ERROR REPORT </p>"; 
          echo"<p> ============= </p>" ;
            $this->load->view('doInsertNotice'); 
        } */ 
